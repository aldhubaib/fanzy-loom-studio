            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="rounded-lg border-2 border-dashed border-border bg-card/50 min-h-[400px] flex flex-col items-center justify-center gap-4 p-8">
                ...
                <p className="text-muted-foreground text-center max-w-md">
                  This is where the <span className="text-foreground font-medium">{currentStage?.title}</span> workspace will live. Click through the pipeline stages in the sidebar to navigate.
                </p>
              </div>
            </div>
          </main>
