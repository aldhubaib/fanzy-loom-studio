        ...
        return (
          <div className="fixed inset-0 z-[100] bg-black/90 flex" onClick={() => setLightbox(null)}>
            ...
            <div className="flex-1 flex items-center justify-center relative" onClick={(e) => e.stopPropagation()}>
              {/* Close */}
              <button
                className="absolute top-4 right-4 w-8 h-8 rounded-lg bg-background/20 hover:bg-background/40 text-foreground flex items-center justify-center transition-colors"
              ...
              {currentIdx > 0 && (
                <button
                  className="absolute left-4 w-10 h-10 rounded-full bg-background/20 hover:bg-background/40 text-foreground flex items-center justify-center transition-colors"
                  onClick={() => setLightbox({ ...lightbox, index: currentIdx - 1 })}
                >
              ...
              <img
                ...
                className="max-w-[80%] max-h-[85vh] object-contain rounded-lg"
              />

              {/* Next */}
              {currentIdx < images.length - 1 && (
                <button
                  className="absolute right-4 w-10 h-10 rounded-full bg-background/20 hover:bg-background/40 text-foreground flex items-center justify-center transition-colors"
                  onClick={() => setLightbox({ ...lightbox, index: currentIdx + 1 })}
                >
            ...
            <div
              className="w-[180px] bg-card/50 backdrop-blur-sm border-l border-border overflow-y-auto p-2 flex flex-col gap-2"
              onClick={(e) => e.stopPropagation()}
            >
              {images.map((img, idx) => {
