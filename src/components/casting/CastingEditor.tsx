        ...
        <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
          ...
          {lookTab === "build" ? (
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="mb-2">
                  <h3 className="text-sm font-semibold text-foreground">AI Character Sheet</h3>
                  <p className="text-[11px] text-muted-foreground">Upload one photo — AI generates all angles</p>
                </div>
                <div className="flex gap-2 items-start">
                  {customPortraits.length > 0 ? (
                    ...
                    <label className="w-20 h-24 rounded-lg border-2 border-dashed border-border hover:border-primary/50 flex flex-col items-center justify-center cursor-pointer transition-colors shrink-0">
                ...
                {/* Generated views placeholder */}
                <div className="grid grid-cols-4 gap-1.5 mt-3">
                  {["Close-up", "3/4 Angle", "Full Body", "Side Profile"].map(view => (
                    <div key={view} className="rounded-lg border border-border bg-secondary/30 aspect-[3/4] flex flex-col items-center justify-center">
                      <User className="w-4 h-4 text-muted-foreground/20 mb-1" />
              ...
              <div>
                <div className="mb-2">
                  <h3 className="text-sm font-semibold text-foreground">Manual Upload</h3>
                  <p className="text-[11px] text-muted-foreground">Upload specific views yourself</p>
                </div>
                <div className="grid grid-cols-4 gap-1.5">
                  {["Close-up", "3/4 Angle", "Full Body", "Side Profile"].map(view => {
                    ...
                    return img ? (
                      <div key={key} className="relative rounded-lg overflow-hidden aspect-[3/4] group">
                        ...
                        <p className="absolute bottom-0 inset-x-0 text-[7px] text-center py-0.5 bg-black/60 text-white">{view}</p>
                      </div>
                    ) : (
                      <label key={key} className="rounded-lg aspect-[3/4] border-2 border-dashed border-border hover:border-primary/50 flex flex-col items-center justify-center cursor-pointer transition-colors">
                        <Upload className="w-3.5 h-3.5 text-muted-foreground mb-0.5" />
                        <span className="text-[7px] text-muted-foreground text-center leading-tight">{view}</span>
                        <input
                          type="file"
                          accept="image/*"
                          className="hidden"
